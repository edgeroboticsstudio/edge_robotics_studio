            ...
            <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8">
                ...
                <div className="lg:col-span-3">
                    ...
                    <div className="flex gap-4">
                        ...
                        <a href="https://www.instagram.com/edgeroboticsstudio/?hl=en" target="_blank" rel="noopener noreferrer" className="p-2 bg-slate-800 rounded-lg hover:bg-primary hover:text-white transition-all">
                            <FaInstagram size={20} />
                        </a>
